...
<form method="post">
    ...
    <tr>
        <td>中文标题 </td>
        <td><input type="text" name="title" value="<?php echo $field['title']?>" /> <br></td>
    </tr>
    <tr>
        <td>父级 </td>
        <td>
                    ...
                    <?php if ($value['_level']!=3): ?>
                        <option value="<?php echo $value['id']?>"
                            <?php if ($value['id']==$field['pid']): ?>
                                selected
                            <?php endif ?>
                        ><?php echo $value['title']?>(<?php echo $value['name']?>)</option>
                    <?php endif ?>
                <?php endforeach ?>
            </select>
        </td>
    ...
    <tr>
        <td>节点动作 </td>
        <td>
            <input type="text" name="name" value="<?php echo $field['name']?>" /> <br>
        </td>
    </tr>
    <tr>
